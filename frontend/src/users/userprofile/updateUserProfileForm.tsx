 ...
 * 
 */
const UpdateUserProfileForm: React.FC<RouteComponentProps> = (props: RouteComponentProps) => {
  ...
  //TODO: change these values with what comes from the GQL query to get user profile
