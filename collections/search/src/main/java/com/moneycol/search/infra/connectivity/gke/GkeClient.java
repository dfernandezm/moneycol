package com.moneycol.search.infra.connectivity.gke;

import com.moneycol.search.infra.connectivity.gke.data.IpAddressType;
import com.moneycol.search.infra.connectivity.gke.data.KubeServiceDetails;
